# Generated by Django 5.2.4 on 2025-09-23 21:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-updated_at'],
                'indexes': [
                    models.Index(fields=['task_id'], name='workspace_j_task_id_8b7659_idx'),
                    models.Index(fields=['state', 'updated_at'], name='workspace_j_state_9ee83d_idx'),
                    models.Index(fields=['user', 'state', 'updated_at'], name='workspace_j_user_id_826c0e_idx'),
                    models.Index(fields=['project', 'state', 'updated_at'], name='workspace_j_project_40c6af_idx'),
                    models.Index(fields=['updated_at'], name='workspace_j_updated_5a3911_idx'),
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [
                    models.Index(fields=['user', 'type', 'created_at'], name='notif_user_type_idx'),
                    models.Index(fields=['project', 'created_at'], name='notif_project_created_idx'),
                    models.Index(fields=['created_at'], name='notif_created_idx'),
                    models.Index(fields=['user', 'created_at'], name='notif_user_readnull_idx', condition=models.Q(read_at__isnull=True)),
                ],
            },
        ),
    ]
